    ...
    return(
        <MainLayout>
            <div className="font-Poppins mx-[305px] mt-[61px]">
                ...
                <div className="mt-[24px] w-[830px] h-[49px] pl-5 pr-60 py-3 bg-white rounded-2xl border border-purple-900 justify-start items-center gap-2 inline-flex">
                    <img src={Search} alt="Icon Search" className="w-[25px] h-[25px] relative"/>
                    <div className="text-black text-opacity-30 text-base font-medium font-['Poppins']">Cari</div>
                </div>
                ...
                <div className="flex flex-row gap-[20px] mx-[108px]">
                    <div className="w-[298px] mt-[36px] h-[332px] px-16 py-8 bg-white rounded-2xl border-2 border-purple-900 flex-col justify-start items-center gap-5 inline-flex">
                        ...
                        <button className="px-16 py-3 bg-purple-200 rounded-3xl justify-center items-center gap-2.5 inline-flex">
                    ...
                    <div className="w-[298px] mt-[36px] h-[332px] px-16 py-8 bg-white rounded-2xl border-2 border-purple-900 flex-col justify-start items-center gap-5 inline-flex">
                        ...
                        <button className="px-16 py-3 bg-purple-200 rounded-3xl justify-center items-center gap-2.5 inline-flex mt-5">
                            <p className="text-center text-purple-900 text-xl font-bold">Pilih</p>
                        </button>
                    </div>
                </div>
