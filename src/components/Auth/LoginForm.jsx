    ...
    return(
        <div className="w-[532px]">
            ...
            <div>
                ...
                <div className="flex">
                    <input id="email" onChange={(e) => setForm({ ...form, email: e.target.value })}  type="email" className="w-[532px] h-[72px] pl-9 pr-[152px] py-7 rounded-3xl border border-purple-900 bg-purple-50 text-purple-900" />
                </div>
            </div>
            <div className="py-5">
                ...
                <div className="flex">
                    <input id="password" onChange={(e) => setForm({ ...form, password: e.target.value })} type="password" className="w-[532px] h-[72px] pl-9 pr-[152px] py-7 rounded-3xl border border-purple-900 bg-purple-50 text-purple-900" />
                </div>
            </div>
