        ...
        <main className="max-w-7xl mx-auto my-11 font-Poppins">
            <div className="box-border flex flex-wrap">
                <article className="w-full md:w-2/4 mt-12 ">
                    ...
                    <button type="button" className="font-semibold text-sm text-purple-50 bg-purple-900 border-2 border-purple-900 rounded-full px-8 py-3 hover:bg-purple-50 mr-5 hover:border-purple-900 hover:text-purple-900">Masuk</button>
                    <button type="button" className="font-semibold text-sm text-purple-900 hover:text-purple-50 border-2  border-purple-900 hover:bg-purple-900 rounded-full px-8 py-3  dark:border-purple-900  dark:hover:bg-purple-900 ">Daftar</button>
                </article>
